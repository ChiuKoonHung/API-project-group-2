...
const ShowForecast = ({}) => {
    ...
    let [isLightOn, updateStatus] = useState();
    ...
    useEffect(()=>{
        ...
        console.log("LY2HrForecast", forecast2h.status);
        console.log("LY24HrForecast", forecast24h.status);
        console.log("LY4dayForecast", forecast4day.status);
